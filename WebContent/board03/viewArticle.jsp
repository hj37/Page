...
<body>
	<%-- 설명 : 컨트롤러에서 바인딩한 글 정보 속성을 이용해 표시합니다. 
			     이미지 파일이 존재하는 경우는 
			     글번호와 이미지 파일 이름을 FileDownloadController서블릿으로 전송한후 
			  <img>태그에 다운로드 하여 표시합니다. --%>
  ...
  <form name="frmArticle" method="post"   enctype="multipart/form-data">
	  <table  border="0" align="center" >
		...
		<%--글쓰기 당시.. 첨부한 파일이 존재 한다면 (imageFileName값이 있으면 이미지를 표시) --%>
		...
		<tr>
		   ...
		   <td>
		     ...
		     <%-- FileDownloadController.java서블릿에 이미지 파일 이름과  글 번호를 전송해  이미지를 <img>태그에 표시함 --%>
